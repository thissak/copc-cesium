...
1. 글로벌 규칙: `/Users/showmethemoney/.claude/CLAUDE.md`
2. 프로젝트 규칙: `./CLAUDE.md`
...
글로벌 스킬 SSOT는 `/Users/showmethemoney/.claude/skills/`입니다.
`/Users/showmethemoney/.agents/skills/`의 동일 이름 항목은 Codex 발견용 포인터로만
