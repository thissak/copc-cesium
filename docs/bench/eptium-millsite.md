...
> 측정 2026-06-17T23:12:15.271Z · 데이터 `millsite` · **msse=8** · 스트레스 5s · 네트워크 none
...
|------|------|--------|
| msse | 8 | 8 |
| numberOfPointsSelected | 728,448 | 1,486,522 |
| tilesReady / total | 79/4522 | 109/3590 |

## Tier 1a — 북극성 (재현·자동, 낮을수록 좋음 ↓)

| 지표 | ours | eptium | Δ(ours vs eptium) |
|------|------|--------|-------------------|
| TTD 풀레솔 도달 | 25199 ms | 7327 ms | +244% |
| 네트워크 bytes | 0.2 MB | 15.9 MB | -99% |
| range 요청 수 | 18 | 116 | -84% |
| peak heap | 73 MB | 120 MB | -39% |
...
## ⚠️ 측정 한계
- numberOfPointsSelected 큰 차이: ours=728,448 vs eptium=1,486,522 (51% 차). msse 정규화가 품질을 동등하게 맞추지 못함. 1a 비교는 참고용.
